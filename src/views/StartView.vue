<template>
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full w-1/2 aspect-square flex flex-col justify-center items-center bg-white gap-16">
